/**
 * Browser Entry Point — Family Zoo v02: Multiple Rooms & Navigation
 */
...
import { story } from './v02.js';

const THEME_STORAGE_KEY = 'familyzoo-02-theme';
