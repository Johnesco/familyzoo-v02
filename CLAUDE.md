# Family Zoo — v02 — Multiple Rooms & Navigation — Claude Project Memory
...
**Name:** Family Zoo — v02 — Multiple Rooms & Navigation
**Purpose:** Sharpee tutorial step 2 — Multiple Rooms & Navigation.
...
**Repository:** https://github.com/Johnesco/familyzoo-v02
**Live:** https://johnesco.github.io/familyzoo-v02/
...
├── familyzoo-02.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v02.story`.
